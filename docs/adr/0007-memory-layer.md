...
- Помнит специфику ПРАЙД — продукты (наружная реклама, POS), клиентов (СОКОЛОВ, KOTON, LC Waikiki, Магнит, Спортмастер), особенности производства.
...
|---|---|---|
| `note` | Структурные факты | «Owner — Дмитрий Рудич, директор ПРАЙД, наружная реклама и POS, Москва» |
